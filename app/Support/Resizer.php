...
class Resizer
{
     ...
     * @param string $mode
     *            Either exact, portrait, landscape, auto or crop.
     * @param array $offset
     *            The offset of the crop = [ left, top ]
     * @return Self
     */
     ...
     *            The output quality of the image
     * @return boolean
     */
     ...
     *
     * @param array $file
     *            Attributes of file from the $_FILES array
     * @return mixed
     */
