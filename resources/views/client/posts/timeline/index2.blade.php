<div class="ui grid border-bottom border-top layout-timeline">
            ...
            <div class="row margin-none">
                <div class="col-md-7">
                    <ul class="nav nav-pills nav-stacked nav-timeline">
                        ...
                        <li>
                            <a href=""><i class="fa fa-fw fa-calendar pull-right"></i>Custom</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="timeline">
                <li class="active">
                    <div class="separator bottom">
                        ...
                        <span class="type"><span class="time">08:00</span></span>
                        <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-fw"></i> Add
                            event
                        </button>
                    </div>
                    ...
                    <div class="widget widget-heading-simple widget-body-gray margin-none">
                        <div class="widget-body">
                            <p class="glyphicons user margin-none">
                                <i></i>
                                <strong><a href="">MosaicPro</a> said</strong>
                        ...
                        <div class="widget-body">
                            ...
                            <div class="alert alert-gray">
                                ...
                                <div class="gallery gallery-2 separator top">
                                    <ul class="row" data-toggle="modal-gallery" data-target="#modal-gallery"
                                        id="gallery-4" data-delegate="#gallery-4">
                                        <li class="col-md-3 hidden-phone">
                                            <a class="thumb" href="../assets/images/gallery-2/6.jpg"
                                               data-gallery="gallery">
                                                <img src="../assets/images/gallery-2/6.jpg" alt="photo"
                                                     class="img-responsive">
                                            </a>
                                        </li>
                                        <li class="col-md-3 hidden-phone">
                                            <a class="thumb" href="../assets/images/gallery-2/5.jpg"
                                               data-gallery="gallery">
                                                <img src="../assets/images/gallery-2/5.jpg" alt="photo"
                                                     class="img-responsive">
                                            </a>
                                        </li>
                                        <li class="col-md-3 hidden-phone">
                                            <a class="thumb" href="../assets/images/gallery-2/4.jpg"
                                               data-gallery="gallery">
                                                <img src="../assets/images/gallery-2/4.jpg" alt="photo"
                                                     class="img-responsive">
                                            </a>
                                        </li>
                                        <li class="col-md-3">
                                            <a class="thumb" href="../assets/images/gallery-2/3.jpg"
                                               data-gallery="gallery">
                                                <img src="../assets/images/gallery-2/3.jpg" alt="photo"
                                                     class="img-responsive">
                                            </a>
                                        </li>
                                        <li class="col-md-3">
                                            <a class="thumb" href="../assets/images/gallery-2/2.jpg"
                                               data-gallery="gallery">
                                                <img src="../assets/images/gallery-2/2.jpg" alt="photo"
                                                     class="img-responsive">
                                            </a>
                                        </li>
                                        <li class="col-md-3">
                                            <a class="thumb" href="../assets/images/gallery-2/1.jpg"
                                               data-gallery="gallery">
                                                <img src="../assets/images/gallery-2/1.jpg" alt="photo"
                                                     class="img-responsive">
                                            </a>
                                        </li>
                                    </ul>
