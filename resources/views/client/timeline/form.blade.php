...
<div class="ui top attached tabular menu uk-hidden-small">
...
<div class="ui top attached tabular icon menu uk-visible-small">
    <a href="#" class="active icon item" data-tab="post-compose"><i class="pencil square icon"></i></a>
    <a href="#" class="icon item" data-tab="post-media"><i class="picture icon"></i></a>
    <a href="#" class="icon item" data-tab="post-link"><i class="linkify icon"></i></a>
</div>
