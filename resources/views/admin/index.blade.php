        ...
        <div class="row">
            <div class="one-half column">
                <div class="table-responsive-vertical shadow-z-1">
                    <!-- Table starts here -->
                    <table id="table" class="ui celled sortable compact striped definition table">
                        <thead>
                        <tr>
                            <th></th>
                            <th>Customer</th>
                        ...
                        <tr>
                            <td class="collapsing" data-title="ID">4</td>
                        ...
                        <tr>
                            <td class="collapsing" data-title="ID">5</td>
                        ...
                        <tr>
                            <td class="collapsing" data-title="ID">6</td>
                        ...
                        <tr>
                            <td class="collapsing" data-title="ID">7</td>
                        ...
                        <tr>
                            <td class="collapsing" data-title="ID">8</td>
            ...
            <div class="one-half column padding-top-20">
                <div class="table-responsive-vertical shadow-z-1">
                    <!-- Table starts here -->
                    <table id="table" class="ui table celled table-hover table-mc-light-blue">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
                        ...
                        <tr>
                            ...
                            <td data-title="Link"><a href="http://codepen.io/zavoloklom/pen/dIgco"
