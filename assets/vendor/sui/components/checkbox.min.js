...
!function (e, n, t, i) {
    ...
    e.fn.checkbox = function (t) {
        var o, a = e(this), c = a.selector || "", r = (new Date).getTime(), d = [], s = arguments[0], l = "string" == typeof s, u = [].slice.call(arguments, 1);
        return a.each(function () {
            var a, b, g = e.extend(!0, {}, e.fn.checkbox.settings, t), h = g.className, m = g.namespace, f = g.selector, p = g.error, k = "." + m, v = "module-" + m, y = e(this), x = e(this).children(f.label), C = e(this).children(f.input), I = y.data(v), O = this;
            b = {
                initialize: function () {
                    ...
                    var i = e(n);
                    t = e.isFunction(b[t]) ? b[t] : b.toggle, i.length > 0 ? (b.debug("Attaching checkbox events to element", n, t), i.on("click" + k, t)) : b.error(p.notFound)
                }, event: {
                    click: function (n) {
                    ...
                    radios: function () {
                        var n = b.get.name();
                        return e('input[name="' + n + '"]').closest(f.checkbox)
                    }, name: function () {
                        return C.attr("name")
                    }
                }, is: {
                    ...
                    log: function (e) {
                        var n, t, i;
                        g.performance && (n = (new Date).getTime(), i = r || n, t = n - i, r = n, d.push({
                            Name: e[0],
                        ...
                        var n = g.name + ":", t = 0;
                        r = !1, clearTimeout(b.performance.timer), e.each(d, function (e, n) {
                            t += n["Execution Time"]
                    ...
                    var c, r, d, s = I;
                    return t = t || u, a = O || a, "string" == typeof n && s !== i && (n = n.split(/[\. ]/), c = n.length - 1, e.each(n, function (t, o) {
                        var a = t != c ? o + n[t + 1].charAt(0).toUpperCase() + n[t + 1].slice(1) : n;
                        if (e.isPlainObject(s[a]) && t != c)s = s[a]; else {
                            if (s[a] !== i)return r = s[a], !1;
                            if (!e.isPlainObject(s[o]) || t == c)return s[o] !== i ? (r = s[o], !1) : (b.error(p.method, n), !1);
                            s = s[o]
                        }
