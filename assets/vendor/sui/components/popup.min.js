...
!function (t, e, o, n) {
    ...
    t.fn.popup = function (i) {
        ...
        return a.each(function () {
            var o, a, v, b, y, w = t.isPlainObject(i) ? t.extend(!0, {}, t.fn.popup.settings, i) : t.extend({}, t.fn.popup.settings), T = w.selector, P = w.className, C = w.error, k = w.metadata, x = w.namespace, S = "." + w.namespace, E = "module-" + x, D = t(this), O = t(w.context), j = w.target ? t(w.target) : D, A = 0, R = !1, F = !1, H = this, I = D.data(E);
            y = {
                initialize: function () {
                    ...
                    start: function (e) {
                        var o = t.isPlainObject(w.delay) ? w.delay.show : w.delay;
                        clearTimeout(y.hideTimer), y.showTimer = setTimeout(y.show, o)
                    }, end: function () {
                        var e = t.isPlainObject(w.delay) ? w.delay.hide : w.delay;
                        clearTimeout(y.showTimer), y.hideTimer = setTimeout(y.hide, e)
                    ...
                    var e = y.get.html(), n = y.get.variation(), i = y.get.title(), r = y.get.content();
                    e || r || i ? (y.debug("Creating pop-up html"), e || (e = w.templates.popup({
                        title: i,
                        content: r
                    ...
                    if (t = t || function () {
                            }, y.debug("Showing pop-up", w.transition), y.is.hidden() && (!y.is.active() || !y.is.dropdown())) {
                        if (y.exists() || y.create(), w.onShow.call(o, H) === !1)return void y.debug("onShow callback returned false, cancelling popup animation");
                        w.preserve || w.popup || y.refresh(), o && y.set.position() && (y.save.conditions(), w.exclusive && y.hideAll(), y.animate.show(t))
                    }
                }, hide: function (t) {
                    if (t = t || function () {
                            }, y.is.visible() || y.is.animating()) {
                        if (w.onHide.call(o, H) === !1)return void y.debug("onHide callback returned false, cancelling popup animation");
                        y.remove.visible(), y.unbind.close(), y.restore.conditions(), y.animate.hide(t)
                    }
                }, hideAll: function () {
                    ...
                    show: function (e) {
                        ...
                        }, w.transition && t.fn.transition !== n && D.transition("is supported") ? (y.set.visible(), o.transition({
                        ...
                        }, y.debug("Hiding pop-up"), w.onShow.call(o, H) === !1 ? void y.debug("onShow callback returned false, cancelling popup animation") : void(w.transition && t.fn.transition !== n && D.transition("is supported") ? o.transition({
                    ...
                    html: function () {
                        ...
                        var t, n = j[0], i = w.inline || w.popup ? j.position() : j.offset(), r = {};
                        return r = {
                            target: {
                                element: j[0],
                                width: j.outerWidth(),
                        ...
                        }, r.target.margin.top = w.inline ? parseInt(e.getComputedStyle(n).getPropertyValue("margin-top"), 10) : 0, r.target.margin.left = w.inline ? y.is.rtl() ? parseInt(e.getComputedStyle(n).getPropertyValue("margin-right"), 10) : parseInt(e.getComputedStyle(n).getPropertyValue("margin-left"), 10) : 0, t = r.screen, r.boundary = {
                            top: t.scroll.top,
                        ...
                        return e = e || !1, n = n || y.get.calculations(), i = n.popup, r = n.boundary, a && e && (s = {
                            top: a.top < r.top,
                            bottom: a.top + i.height > r.bottom,
                            right: a.left + i.width > r.right,
                            left: a.left < r.left
                        }, y.verbose("Offstage positions determined", a, s)), t.each(s, function (t, e) {
                            e && p.push(t)
                        }), p.length > 0 ? p.join(" ") : !1
                    }, positions: function () {
                        return {
                        ...
                        return R || (y.verbose("All available positions available"), R = y.get.positions()), y.debug("Recording last position tried", t), R[t] = !0, "opposite" === w.prefer && (u = [i[o], n], u = u.join(" "), p = R[u] === !0, y.debug("Trying opposite strategy", u)), "adjacent" === w.prefer && s && (u = [o, r[n]], u = u.join(" "), l = R[u] === !0, y.debug("Trying adjacent strategy", u)), (l || p) && (y.debug("Using backup position", u), u = a[t]), u
                    }
                }, set: {
                    position: function (t, e) {
                        if (0 === j.length || 0 === o.length)return void y.error(C.notFound);
                        var i, r, a, s, p, l, u;
                        if (e = e || y.get.calculations(), t = t || D.data(k.position) || w.position, i = D.data(k.offset) || w.offset, r = w.distanceAway, a = e.target, s = e.popup, p = e.parent, 0 === a.top && 0 === a.left)return y.debug("Popup target is hidden, no action taken"), !1;
                        ...
                        }), y.debug("RTL: Popup position updated", t)), A == w.maxSearchDepth && w.lastResort && (y.debug('Using "last resort" position to display', w.lastResort), t = w.lastResort), t) {
                            case"top left":
                        ...
                        if (l === n && y.error(C.invalidPosition, t), y.debug("Calculated popup positioning values", l), o.css(l).removeClass(P.position).addClass(t).addClass(P.loading), u = y.get.offstagePosition(t, e)) {
                            if (y.debug("Popup cant fit into viewport", t, u), A < w.maxSearchDepth)return A++, t = y.get.nextPosition(t), y.debug("Trying new position", t), o ? y.set.position(t, e) : !1;
                            if (!w.lastResort)return y.debug("Popup could not find a position in view", o), y.remove.attempts(), y.remove.loading(), y.reset(), !1
                        }
                    ...
                    log: function (t) {
                        var e, o, n;
                        w.performance && (e = (new Date).getTime(), n = d || e, o = e - n, d = e, f.push({
                            Name: t[0],
                        ...
                        var e = w.name + ":", o = 0;
                        d = !1, clearTimeout(y.performance.timer), t.each(f, function (t, e) {
                            o += e["Execution Time"]
