...
!function (e, t, a, n) {
    ...
    e.fn.tab = function (i) {
        ...
        return r.each(function () {
            var f, h, p, m, v, y, T = e.isPlainObject(i) ? e.extend(!0, {}, e.fn.tab.settings, i) : e.extend({}, e.fn.tab.settings), L = T.className, x = T.metadata, A = T.selector, P = T.error, C = "." + T.namespace, F = "module-" + T.namespace, S = e(this), E = {}, j = !0, k = 0, I = this, w = S.data(F);
            v = {
                initialize: function () {
                    ...
                    var r, s, c, l = w;
                    return a = a || b, i = I || i, "string" == typeof t && l !== n && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (a, i) {
