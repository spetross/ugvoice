...
!function (e, t, n, i) {
    ...
    e.fn.dropdown = function (a) {
        var o, r = e(this), s = e(n), l = r.selector || "", c = "ontouchstart"in n.documentElement, u = (new Date).getTime(), d = [], v = arguments[0], m = "string" == typeof v, f = [].slice.call(arguments, 1);
            ...
            S = {
                initialize: function () {
                    ...
                    api: function () {
                        ...
                        var e = r.slice(0, h), t = r.slice(h + 1);
                        r = e.add(E).add(t)
                    }
                }, refresh: function () {
                    ...
                    var n = t !== i ? t : S.get.query(), a = e(), o = S.escape.regExp(n), r = new RegExp("^" + o, "igm");
                    "" === n ? a = N : (S.verbose("Searching for matching values", n), N.each(function () {
                        var t, i, o = e(this);
                        if ("both" == y.match || "text" == y.match) {
                            if (t = String(S.get.choiceText(o, !1)), -1 !== t.search(r))return a = a.add(o), !0;
                            if (y.fullTextSearch && S.fuzzySearch(n, t))return a = a.add(o), !0
                        }
                        if ("both" == y.match || "value" == y.match) {
                            if (i = String(S.get.choiceValue(o, t)), -1 !== i.search(r))return a = a.add(o), !0;
                    ...
                    e:for (var a = 0, o = 0; i > a; a++) {
                        for (var r = e.charCodeAt(a); n > o;)if (t.charCodeAt(o++) === r)continue e;
                        return !1
                    }
                    return !0
                    ...
                    focus: function () {
                        ...
                        var n = e(t.target);
                        !n.is(E) && !n.is(H) || S.is.focusedOnSearch() || S.focusSearch()
                    }, blur: function (e) {
                        ...
                        click: function (t) {
                            var n = e(this), i = E.find(I.label), a = i.filter("." + A.active), o = n.nextAll("." + A.active), r = n.prevAll("." + A.active), s = o.length > 0 ? n.nextUntil(o).add(a).add(n) : n.prevUntil(r).add(a).add(n);
                            t.shiftKey ? (a.removeClass(A.active), s.addClass(A.active)) : t.ctrlKey ? n.toggleClass(A.active) : (a.removeClass(A.active), n.addClass(A.active)), y.onLabelSelect.apply(this, i.filter("." + A.active))
                        }
                    }, remove: {
                        click: function () {
                            var t = e(this).parent();
                        ...
                        mouseenter: function (t) {
                            ...
                            var n = e(this), i = e(t ? t.target : ""), a = n.find(I.menu), o = S.get.choiceText(n), r = S.get.choiceValue(n, o), s = a.length > 0, l = a.find(i).length > 0;
                            l || s && !y.allowCategorySelection || (y.useLabels || S.remove.searchTerm(), S.determine.selectAction.call(this, o, r))
                        }
                    }, document: {
                        keydown: function (e) {
                            var t = e.which, n = S.get.shortcutKeys(), i = S.is.inObject(t, n);
                            if (i) {
                                var a = E.find(I.label), o = a.filter("." + A.active), r = (o.data("value"), a.index(o)), s = a.length, l = o.length > 0, c = o.length > 1, u = 0 === r, d = r + 1 == s, v = S.is.searchSelection(), m = S.is.focusedOnSearch(), f = S.is.focused(), h = m && 0 === S.get.caretPosition();
                                if (v && !l && !m)return;
                    ...
                    selectAction: function (t, n) {
                        ...
                        }, 0 === e(t.target).closest(E).length ? (S.verbose("Triggering event", n), n(), !0) : (S.verbose("Event occurred in dropdown, canceling callback"), !1)
                    }, eventOnElement: function (t, n) {
                        var i = e(t.target);
                        return n = e.isFunction(n) ? n : function () {
                        }, 0 === i.closest(U).length ? (S.verbose("Triggering event", n), n(), !0) : (S.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    ...
                    id: function () {
                        ...
                        return t.values = [], E.find("option").each(function () {
                            var n = e(this), a = n.html(), o = n.attr("disabled"), r = n.attr("value") !== i ? n.attr("value") : a;
                            "auto" === y.placeholder && "" === r ? t.placeholder = a : t.values.push({
                                name: a,
                                value: r,
                                disabled: o
                            })
                        ...
                        return t = t !== i ? t : S.get.values() !== i ? S.get.values() : S.get.text(), a = o ? t.length > 0 : t !== i && "" !== t && null !== t, o = S.is.multiple() && e.isArray(t), n = "" === t || 0 === t ? !0 : n || !1, a && N.each(function () {
                            var a = e(this), s = S.get.choiceText(a), l = S.get.choiceValue(a, s);
                            if (null !== l && l !== i)if (o)(-1 !== e.inArray(l.toString(), t) || -1 !== e.inArray(s, t)) && (r = r ? r.add(a) : a); else if (n) {
                    ...
                    var n, i, a, t = t || S.get.selectedItem(), o = t.closest(I.menu), r = o.outerHeight(), s = o.scrollTop(), l = N.eq(0).outerHeight(), c = Math.floor(r / l), u = (o.prop("scrollHeight"), "up" == e ? s - l * c : s + l * c), d = N.not(I.unselectable);
                    ...
                    filtered: function () {
                        var e = S.is.multiple(), t = S.is.searchSelection(), n = e && t, i = t ? S.get.query() : "", a = "string" == typeof i && i.length > 0, o = S.get.searchWidth(i.length), r = "" !== i;
                        e && a && (S.verbose("Adjusting input width", o, y.glyphWidth), M.css("width", o)), a || n && r ? (S.verbose("Hiding placeholder text"), P.addClass(A.filtered)) : (!e || n && !r) && (S.verbose("Showing placeholder text"), P.removeClass(A.filtered))
                    }, loading: function () {
                        ...
                        var n, a, o, r, s, l, c, u, d, v = 5;
                        e = e || S.get.selectedItem(), n = e.closest(I.menu), a = e && e.length > 0, t = t !== i ? t : !1, e && n.length > 0 && a && (r = e.position().top, n.addClass(A.loading), l = n.scrollTop(), s = n.offset().top, r = e.offset().top, o = l - s + r, t || (c = n.height(), d = o + v > l + c, u = l > o - v), S.debug("Scrolling to active item", o), (t || u || d) && n.scrollTop(o), n.removeClass(A.loading))
                    }, text: function (e) {
                        ...
                        var n = N.filter("." + A.selected), i = !1;
                        N.each(function () {
                            var n = e(this), a = S.get.choiceText(n, !1), o = String(a).charAt(0).toLowerCase(), r = t.toLowerCase();
                            return o == r ? (i = n, !1) : void 0
                    ...
                    show: function (t, n) {
                        var a, o = n || U, r = n ? function () {
                        } : function () {
                            S.hideSubMenus(), S.hideOthers(), S.set.active()
                        };
                        t = e.isFunction(t) ? t : function () {
                        }, S.verbose("Doing menu show animation", o), S.set.direction(n), a = S.get.transition(n), S.is.selection() && S.set.scrollPosition(S.get.selectedItem(), !0), (S.is.hidden(o) || S.is.animating(o)) && ("none" == a ? (r(), o.transition("show"), t.call(B)) : e.fn.transition !== i && E.transition("is supported") ? o.transition({
                            animation: a + " in",
                            debug: y.debug,
                            verbose: y.verbose,
                            duration: y.duration,
                        ...
                        t = e.isFunction(t) ? t : function () {
                        }, (S.is.visible(a) || S.is.animating(a)) && (S.verbose("Doing menu hide animation", a), "none" == r ? (o(), a.transition("hide"), t.call(B)) : e.fn.transition !== i && E.transition("is supported") ? a.transition({
                            animation: r + " out",
                            duration: y.duration,
                            debug: y.debug,
                            verbose: y.verbose,
                    ...
                    var r, s, l, c = $;
                    return n = n || f, a = B || a, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, a) {
                        var o = n != r ? a + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[o]) && n != r)c = c[o]; else {
                            if (c[o] !== i)return s = c[o], !1;
                            if (!e.isPlainObject(c[a]) || n == r)return c[a] !== i ? (s = c[a], !1) : (S.error(R.method, t), !1);
                            c = c[a]
                        }
