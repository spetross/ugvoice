...
!function (e, t, n, i) {
    e.site = e.fn.site = function (o) {
        var a, r, s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1), f = e.isPlainObject(o) ? e.extend(!0, {}, e.site.settings, o) : e.extend({}, e.site.settings), m = f.namespace, g = f.error, p = "module-" + m, h = e(n), v = h, b = this, y = v.data(p);
        return a = {
            initialize: function () {
                a.instantiate()
    ...
    e.fn.form = function (t) {
        ...
        return a.each(function () {
            var m, g, p, h, v, b, y, x, C, w, k, S, T, A, P, R, E, D, O = e(this), F = this, q = [], j = !1;
            D = {
                initialize: function () {
                    D.get.settings(), d ? (E === i && D.instantiate(), D.invoke(l)) : (D.verbose("Initializing form validation", O, x), D.bindEvents(), D.set.defaults(), D.instantiate())
                }, instantiate: function () {
                    D.verbose("Storing instance of module", D), E = D, O.data(P, D)
                }, destroy: function () {
                    D.verbose("Destroying previous module", E), D.removeEvents(), O.removeData(P)
                }, refresh: function () {
                    D.verbose("Refreshing selector cache"), m = O.find(k.field), g = O.find(k.group), p = O.find(k.message), h = O.find(k.prompt), v = O.find(k.submit), b = O.find(k.clear), y = O.find(k.reset)
                }, submit: function () {
                    ...
                    D.verbose("Attaching form events"), O.on("submit" + R, D.validate.form).on("blur" + R, k.field, D.event.field.blur).on("click" + R, k.submit, D.submit).on("click" + R, k.reset, D.reset).on("click" + R, k.clear, D.clear), x.keyboardShortcuts && O.on("keydown" + R, k.field, D.event.field.keydown), m.each(function () {
                        var t = e(this), n = t.prop("type"), i = D.get.changeEvent(n, t);
                        e(this).on(i + R, D.event.field.change)
                    })
                }, clear: function () {
                    m.each(function () {
                        ...
                        c && (D.verbose("Resetting error on field", i), i.removeClass(S.error), o.remove()), s ? (D.verbose("Resetting dropdown value", n, a), n.dropdown("clear")) : r ? t.prop("checked", !1) : (D.verbose("Resetting field value", t, a), t.val(""))
                    })
                }, reset: function () {
                    m.each(function () {
                        ...
                        r === i && (r = ""), l && (D.verbose("Resetting error on field", o), o.removeClass(S.error), a.remove()), c ? (D.verbose("Resetting dropdown value", n, r), n.dropdown("restore defaults")) : s ? (D.verbose("Resetting checkbox value", n, r), t.prop("checked", r)) : (D.verbose("Resetting field value", t, r), t.val(r))
                    })
                }, is: {
                    valid: function () {
                        var t = !0;
                        return D.verbose("Checking if form is valid"), e.each(C, function (e, n) {
                            D.validate.field(n) || (t = !1)
                        }), t
                    }
                }, removeEvents: function () {
                    O.off(R), m.off(R), v.off(R), m.off(R)
                }, event: {
                    field: {
                        keydown: function (t) {
                            var n = e(this), i = t.which, o = {enter: 13, escape: 27};
                            i == o.escape && (D.verbose("Escape key pressed blurring field"), n.blur()), !t.ctrlKey && i == o.enter && n.is(k.input) && n.not(k.checkbox).length > 0 && (j || (n.one("keyup" + R, D.event.field.keyup), D.submit(), D.debug("Enter pressed on input submitting form")), j = !0)
                        }, keyup: function () {
                            j = !1
                        }, blur: function () {
                            var t = e(this), n = t.closest(g), i = D.get.validation(t);
                            n.hasClass(S.error) ? (D.debug("Revalidating field", t, i), D.validate.field(i)) : ("blur" == x.on || "change" == x.on) && D.validate.field(i)
                        }, change: function () {
                            var t = e(this), n = t.closest(g);
                            ("change" == x.on || n.hasClass(S.error) && x.revalidate) && (clearTimeout(D.timer), D.timer = setTimeout(function () {
                                D.debug("Revalidating field", t, D.get.validation(t)), D.validate.field(D.get.validation(t))
                            }, x.delay))
                        }
                    }
                }, get: {
                    changeEvent: function (e, t) {
                        ...
                        if (e.isPlainObject(t)) {
                            ...
                            o ? (x = e.extend(!0, {}, e.fn.form.settings, u), C = e.extend({}, e.fn.form.settings.defaults, t), D.error(x.error.oldSyntax, F), D.verbose("Extending settings from legacy parameters", C, x)) : (x = e.extend(!0, {}, e.fn.form.settings, t), C = e.extend({}, e.fn.form.settings.defaults, x.fields), D.verbose("Extending settings", C, x))
                        } else x = e.fn.form.settings, C = e.fn.form.settings.defaults, D.verbose("Using default form validation", C, x);
                        A = x.namespace, w = x.metadata, k = x.selector, S = x.className, T = x.error, P = "module-" + A, R = "." + A, E = O.data(P), D.refresh()
                    }, field: function (t) {
                        return D.verbose("Finding field with identifier", t), m.filter("#" + t).length > 0 ? m.filter("#" + t) : m.filter('[name="' + t + '"]').length > 0 ? m.filter('[name="' + t + '"]') : m.filter('[name="' + t + '[]"]').length > 0 ? m.filter('[name="' + t + '[]"]') : m.filter("[data-" + w.validate + '="' + t + '"]').length > 0 ? m.filter("[data-" + w.validate + '="' + t + '"]') : e("<input/>")
                    }, fields: function (t) {
                        var n = e();
                        ...
                        return C ? (e.each(C, function (e, i) {
                            D.get.field(i.identifier)[0] == t[0] && (n = i)
                        }), n || !1) : !1
                    }, value: function (e) {
                        var t, n = [];
                        return n.push(e), t = D.get.values.call(F, n), t[e]
                    }, values: function (t) {
                        var n = e.isArray(t) ? D.get.fields(t) : m, i = {};
                        return n.each(function (t, n) {
                            ...
                            if (a)if (l)if (a = a.replace("[]", ""), i[a] || (i[a] = []), s) {
                                if (!u)return D.debug("Omitted unchecked checkbox", o), !0;
                                i[a].push(r)
                    ...
                    field: function (e) {
                        return D.verbose("Checking for existence of a field with identifier", e), m.filter("#" + e).length > 0 ? !0 : m.filter('[name="' + e + '"]').length > 0 ? !0 : m.filter("[data-" + w.validate + '="' + e + '"]').length > 0 ? !0 : !1
                    }
                }, add: {
                    prompt: function (t, n) {
                        var o = D.get.field(t), a = o.closest(g), r = a.children(k.prompt), s = 0 !== r.length;
                        ...
                        D.debug("Adding form error messages", e), p.html(x.templates.error(e))
                    }
                }, remove: {
                    prompt: function (t) {
                        var n = D.get.field(t.identifier), o = n.closest(g), a = o.children(k.prompt);
                        o.removeClass(S.error), x.inline && a.is(":visible") && (D.verbose("Removing prompt for field", t), x.transition && e.fn.transition !== i && O.transition("is supported") ? a.transition(x.transition + " out", x.duration, function () {
                            a.remove()
                    ...
                    success: function () {
                        ...
                        var n = {};
                        return n[e] = t, D.set.values.call(F, n)
                    }, values: function (t) {
                        e.isEmptyObject(t) || e.each(t, function (t, n) {
                            var i, o = D.get.field(t), a = o.parent(), r = e.isArray(n), s = a.is(k.uiCheckbox), c = a.is(k.uiDropdown), l = o.is(k.radio) && s, u = o.length > 0;
                            u && (r && s ? (D.verbose("Selecting multiple", n, o), a.checkbox("uncheck"), e.each(n, function (e, t) {
                                i = o.filter('[value="' + t + '"]'), a = i.parent(), i.length > 0 && a.checkbox("check")
                            })) : l ? (D.verbose("Selecting radio value", n, o), o.filter('[value="' + n + '"]').parent(k.uiCheckbox).checkbox("check")) : s ? (D.verbose("Setting checkbox value", n, a), a.checkbox(n === !0 ? "check" : "uncheck")) : c ? (D.verbose("Setting dropdown value", n, a), a.dropdown("set selected", n)) : (D.verbose("Setting field value", n, o), o.val(n)))
                        })
                    }
                }, validate: {
                    form: function (e) {
                        return j ? !1 : (q = [], D.is.valid() ? (D.debug("Form has no validation errors, submitting"), D.set.success(), x.onSuccess.call(F, e)) : (D.debug("Form has errors"), D.set.error(), x.inline || D.add.errors(q), O.data("moduleApi") !== i && e.stopImmediatePropagation(), x.onFailure.call(F, q)))
                    }, field: function (t) {
                        var n = D.get.field(t.identifier), o = !0, a = [];
                        return n.prop("disabled") ? (D.debug("Field is disabled. Skipping", t.identifier), o = !0) : t.optional && "" === e.trim(n.val()) ? (D.debug("Field is optional and empty. Skipping", t.identifier), o = !0) : t.rules !== i && e.each(t.rules, function (e, n) {
                            D.has.field(t.identifier) && !D.validate.rule(t, n) && (D.debug("Field is invalid", t.identifier, n.type), a.push(n.prompt), o = !1)
                        }), o ? (D.remove.prompt(t, a), x.onValid.call(n), !0) : (q = q.concat(a), D.add.prompt(t.identifier, a), x.onInvalid.call(n, a), !1)
                    }, rule: function (t, n) {
                        var i, o, a, r = D.get.field(t.identifier), s = n.type, c = r.val(), l = s.match(x.regExp.bracket), u = !0;
                        if (c = e.trim(r.val() + ""), l) {
                            if (o = "" + l[1], a = s.replace(l[0], ""), i = x.rules[a], !e.isFunction(i))return void D.error(T.noRule, a);
                            u = i.call(r, c, o)
                        } else {
                            if (i = x.rules[s], !e.isFunction(i))return void D.error(T.noRule, s);
                            u = i.call(r, c)
                        }
                        return u
                    }
                    ...
                    x.debug && (x.performance ? D.performance.log(arguments) : (D.debug = Function.prototype.bind.call(console.info, console, x.name + ":"), D.debug.apply(console, arguments)))
                }, verbose: function () {
                    x.verbose && x.debug && (x.performance ? D.performance.log(arguments) : (D.verbose = Function.prototype.bind.call(console.info, console, x.name + ":"), D.verbose.apply(console, arguments)))
                }, error: function () {
                    D.error = Function.prototype.bind.call(console.error, console, x.name + ":"), D.error.apply(console, arguments)
                }, performance: {
                    log: function (e) {
                        var t, n, i;
                        ...
                        var t = x.name + ":", n = 0;
                        s = !1, clearTimeout(D.performance.timer), e.each(c, function (e, t) {
                            n += t["Execution Time"]
                    ...
                    var r, s, c, l = E;
                    return n = n || f, a = F || a, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
    ...
    e.fn.accordion = function (n) {
        ...
        return a.each(function () {
            ...
            f = {
                initialize: function () {
                    f.debug("Initializing", C), f.bind.events(), f.observeChanges(), f.instantiate()
                }, instantiate: function () {
                    T = f, C.data(y, f)
                }, destroy: function () {
                    ...
                    var n = t !== i ? "number" == typeof t ? w.eq(t) : e(t).closest(h.title) : e(this).closest(h.title), o = n.next(k), a = o.hasClass(g.animating), r = o.hasClass(g.active), s = r && !a, c = !r && a;
                    ...
                    var n, o, a, r = t !== i ? w.eq(t) : e(this).closest(h.title), s = r.parents(h.content).prev(h.title), c = r.closest(h.accordion), l = h.title + "." + g.active + ":visible", u = h.content + "." + g.active + ":visible";
    ...
    e.fn.checkbox = function (n) {
        ...
        return a.each(function () {
            var a, f, m = e.extend(!0, {}, e.fn.checkbox.settings, n), g = m.className, p = m.namespace, h = m.selector, v = m.error, b = "." + p, y = "module-" + p, x = e(this), C = e(this).children(h.label), w = e(this).children(h.input), k = x.data(y), S = this;
            f = {
                initialize: function () {
                    ...
                    f.is.indeterminate() ? (f.debug("Initial value is indeterminate"), f.set.indeterminate(), m.fireOnInit && (m.onIndeterminate.call(w[0]), m.onChange.call(w[0]))) : f.is.checked() ? (f.debug("Initial value is checked"), f.set.checked(), m.fireOnInit && (m.onChecked.call(w[0]), m.onChange.call(w[0]))) : (f.debug("Initial value is unchecked"), f.set.unchecked(), m.fireOnInit && (m.onUnchecked.call(w[0]), m.onChange.call(w[0])))
                }, refresh: function () {
                    C = x.children(h.label), w = x.children(h.input)
                }, hide: {
                    input: function () {
                    ...
                    "MutationObserver"in t && (a = new MutationObserver(function (e) {
                        f.debug("DOM tree modified, updating selector cache"), f.refresh()
                    }), a.observe(S, {childList: !0, subtree: !0}), f.debug("Setting up mutation observer", a))
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    ...
                    click: function (t) {
                        return e(t.target).is(h.input) ? void f.verbose("Using default check action on initialized checkbox") : void f.toggle()
                    }, keydown: function (e) {
                        var t = e.which, n = {enter: 13, space: 32, escape: 27};
                        t == n.escape && (f.verbose("Escape key pressed blurring field"), w.blur(), e.preventDefault()), e.ctrlKey || t != n.enter && t != n.space || (f.verbose("Enter key pressed, toggling checkbox"), f.toggle(), e.preventDefault())
                    }
                }, check: function () {
                    return !f.is.indeterminate() && f.is.checked() ? void f.debug("Checkbox is already checked") : (f.debug("Checking checkbox", w), f.set.checked(), m.onChecked.call(w[0]), void m.onChange.call(w[0]))
                }, uncheck: function () {
                    return !f.is.indeterminate() && f.is.unchecked() ? void f.debug("Checkbox is already unchecked") : (f.debug("Unchecking checkbox"), f.set.unchecked(), m.onUnchecked.call(w[0]), void m.onChange.call(w[0]))
                }, indeterminate: function () {
                    return f.is.indeterminate() ? void f.debug("Checkbox is already indeterminate") : (f.debug("Making checkbox indeterminate"), f.set.indeterminate(), m.onIndeterminate.call(w[0]), void m.onChange.call(w[0]))
                }, determinate: function () {
                    return f.is.determinate() ? void f.debug("Checkbox is already determinate") : (f.debug("Making checkbox determinate"), f.set.determinate(), m.onDeterminate.call(w[0]), void m.onChange.call(w[0]))
                }, enable: function () {
                    return f.is.enabled() ? void f.debug("Checkbox is already enabled") : (f.debug("Enabling checkbox"), f.set.enabled(), void m.onEnable.call(w[0]))
                }, disable: function () {
                    return f.is.disabled() ? void f.debug("Checkbox is already disabled") : (f.debug("Disabling checkbox"), f.set.disabled(), void m.onDisable.call(w[0]))
                }, get: {
                    radios: function () {
                        var t = f.get.name();
                    ...
                    checked: function () {
                        return !f.is.indeterminate() && f.is.checked() ? void f.debug("Input is already checked") : (f.verbose("Setting state to checked", w[0]), f.is.radio() && f.uncheckOthers(), w.prop("indeterminate", !1).prop("checked", !0),
                            x.removeClass(g.indeterminate).addClass(g.checked), void f.trigger.change())
                    }, unchecked: function () {
                        return !f.is.indeterminate() && f.is.unchecked() ? void f.debug("Input is already unchecked") : (f.debug("Setting state to unchecked"), w.prop("indeterminate", !1).prop("checked", !1), x.removeClass(g.indeterminate).removeClass(g.checked), void f.trigger.change())
                    }, indeterminate: function () {
                        return f.is.indeterminate() ? void f.debug("Input is already indeterminate") : (f.debug("Setting state to indeterminate"), w.prop("indeterminate", !0), x.addClass(g.indeterminate), void f.trigger.change())
                    }, determinate: function () {
                        return f.is.determinate() ? void f.debug("Input is already determinate") : (f.debug("Setting state to determinate"), w.prop("indeterminate", !1), void x.removeClass(g.indeterminate))
                    }, disabled: function () {
                        return f.is.disabled() ? void f.debug("Input is already disabled") : (f.debug("Setting state to disabled"), w.prop("disabled", "disabled"), x.addClass(g.disabled), void f.trigger.change())
                    }, enabled: function () {
                        return f.is.enabled() ? void f.debug("Input is already enabled") : (f.debug("Setting state to enabled"), w.prop("disabled", !1), x.removeClass(g.disabled), void f.trigger.change())
                    }, tabbable: function () {
                    ...
                    events: function () {
                        f.verbose("Attaching checkbox events"), x.on("click" + b, f.event.click).on("keydown" + b, h.input, f.event.keydown)
                    }
                }, unbind: {
                    events: function () {
        ...
        return a.each(function () {
            ...
            m = {
                preinitialize: function () {
                    ...
                    m.debug("Initializing dimmer", g), "hover" == g.on ? f.on("mouseenter" + y, m.show).on("mouseleave" + y, m.hide) : "click" == g.on && f.on(w + y, m.toggle), m.is.page() && (m.debug("Setting as a page dimmer", f), m.set.pageDimmer()), m.is.closable() && (m.verbose("Adding dimmer close event", d), f.on(w + y, p.dimmer, m.event.click)), m.set.dimmable(), m.instantiate()
                }, instantiate: function () {
                    m.verbose("Storing instance of module", m), T = m, k.data(x, T)
                }, destroy: function () {
                    m.verbose("Destroying previous module", d), k.removeData(x), f.off(y)
                }, event: {
                    click: function (t) {
    ...
    e.fn.dropdown = function (o) {
        ...
        return r.each(function (p) {
            var h, v, b, y, x, C, w, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings), S = k.className, T = k.message, A = k.metadata, P = k.namespace, R = k.regExp, E = k.selector, D = k.error, O = k.templates, F = "." + P, q = "module-" + P, j = e(this), z = e(k.context), I = j.find(E.text), L = j.find(E.search), N = j.find(E.input), V = j.find(E.icon), H = j.prev().find(E.text).length > 0 ? j.prev().find(E.text) : j.prev(), M = j.children(E.menu), U = M.find(E.item), B = !1, W = !1, Q = this, $ = j.data(q);
            w = {
                initialize: function () {
                    ...
                    w.verbose("Storing instance of dropdown", w), $ = w, j.data(q, w)
                }, destroy: function () {
                    w.verbose("Destroying previous dropdown", j), w.remove.tabbable(), j.off(F).removeData(q), M.off(F), s.off(b), x && x.disconnect(), C && C.disconnect()
                }, observeChanges: function () {
                    ...
                    api: function () {
                        ...
                        j.is("select") && (w.setup.select(), w.setup.returnedObject(), console.log(j)), w.is.search() && !w.has.search() && (w.verbose("Adding search input"), L = e("<input />").addClass(S.search).insertBefore(I)), k.allowTab && w.set.tabbable(), 0 === M.length && (M = e("<div />").addClass(S.menu).appendTo(j))
                    }, select: function () {
                        var t = w.get.selectValues();
                        w.debug("Dropdown initialized on a select", t), j.is("select") && (N = j), N.parent(E.dropdown).length > 0 ? (w.debug("UI dropdown already exists. Creating dropdown menu only"), j = N.closest(E.dropdown), M = j.children(E.menu), w.setup.menu(t)) : (w.debug("Creating entire dropdown from select"), j = e("<div />").attr("class", N.attr("class")).addClass(S.selection).addClass(S.dropdown).html(O.dropdown(t)).insertBefore(N), N.removeAttr("class").detach().prependTo(j), console.log(j)), N.is("[multiple]") && w.set.multiple(), w.refresh()
                    }, menu: function (e) {
                        M.html(O.menu(e)), U = M.find(E.item)
                    }, reference: function () {
                        w.debug("Dropdown behavior was called on select, replacing with closest dropdown"), j = j.parent(E.dropdown), w.refresh(), w.setup.returnedObject(), m && ($ = w, w.invoke(f))
                    ...
                    w.verbose("Refreshing selector cache"), I = j.find(E.text), L = j.find(E.search), N = j.find(E.input), V = j.find(E.icon), H = j.prev().find(E.text).length > 0 ? j.prev().find(E.text) : j.prev(), M = j.children(E.menu), U = M.find(E.item)
                    ...
                    keyboardEvents: function () {
                        w.debug("Binding keyboard events"), j.on("keydown" + F, w.event.keydown), w.has.search() && j.on(w.get.inputEvent() + F, E.search, w.event.input), w.is.multiple() && s.on("keydown" + b, w.event.document.keydown)
                    }, touchEvents: function () {
                        w.debug("Touch device detected binding additional touch events"), w.is.searchSelection() || j.on("touchstart" + F, w.event.test.toggle), M.on("touchstart" + F, E.item, w.event.item.mouseenter)
                    }, mouseEvents: function () {
                        w.debug("Mouse detected binding mouse events"), w.is.multiple() && j.on("click" + F, E.label, w.event.label.click).on("click" + F, E.remove, w.event.remove.click), w.is.searchSelection() ? (j.on("mousedown" + F, E.menu, w.event.menu.mousedown).on("mouseup" + F, E.menu, w.event.menu.mouseup).on("click" + F, E.search, w.show).on("focus" + F, E.search, w.event.search.focus).on("blur" + F, E.search, w.event.search.blur).on("click" + F, E.text, w.event.text.focus), w.is.multiple() && j.on("click" + F, w.event.click)) : ("click" == k.on ? j.on("click" + F, w.event.test.toggle) : "hover" == k.on ? j.on("mouseenter" + F, w.delay.show).on("mouseleave" + F, w.delay.hide) : j.on(k.on + F, w.toggle), j.on("mousedown" + F, w.event.mousedown).on("mouseup" + F, w.event.mouseup).on("focus" + F, w.event.focus).on("blur" + F, w.event.blur)), M.on("mouseenter" + F, E.item, w.event.item.mouseenter).on("mouseleave" + F, E.item, w.event.item.mouseleave).on("click" + F, E.item, w.event.item.click)
                    }, intent: function () {
                    ...
                    w.is.search() && !w.is.focusedOnSearch() && L[0].focus()
                    ...
                    focus: function () {
                        ...
                        var n = e(t.target);
                        !n.is(j) && !n.is(V) || w.is.focusedOnSearch() || w.focusSearch()
                    }, blur: function (e) {
                        ...
                        focus: function () {
                            ...
                            v = n.activeElement === this, W || v || (w.is.multiple() ? (w.remove.activeLabel(), w.hide()) : k.forceSelection ? w.forceSelection() : w.hide())
                        }
                    }, text: {
                        focus: function (e) {
                            B = !0, w.focusSearch()
                        ...
                        mouseenter: function (t) {
                            ...
                            c || s && !k.allowCategorySelection || (k.useLabels || w.remove.searchTerm(), w.determine.selectAction.call(this, a, r))
                        }
                    }, document: {
                        keydown: function (e) {
                            var t = e.which, n = w.get.shortcutKeys(), i = w.is.inObject(t, n);
                            if (i) {
                                var o = j.find(E.label), a = o.filter("." + S.active), r = (a.data("value"), o.index(a)), s = o.length, c = a.length > 0, l = a.length > 1, u = 0 === r, d = r + 1 == s, f = w.is.searchSelection(), m = w.is.focusedOnSearch(), g = w.is.focused(), p = m && 0 === w.get.caretPosition();
                                if (f && !c && !m)return;
                        ...
                        var t = e.which, n = w.get.shortcutKeys(), i = w.is.inObject(t, n);
                        if (i) {
                            var o, a, r = U.not(E.unselectable).filter("." + S.selected).eq(0), s = M.children("." + S.active).eq(0), c = r.length > 0 ? r : s, l = c.length > 0 ? c.siblings(":not(." + S.filtered + ")").andSelf() : M.children(":not(." + S.filtered + ")"), u = c.children(E.menu), d = c.closest(E.menu), f = d.hasClass(S.visible) || d.hasClass(S.animating) || d.parent(E.menu).length > 0, m = u.length > 0, g = c.length > 0, p = c.not(E.unselectable).length > 0;
                            if (w.is.visible()) {
                                if ((t == n.enter || t == n.delimiter) && (t == n.enter && g && m && !k.allowCategorySelection ? (w.verbose("Pressed enter on unselectable category, opening sub menu"), t = n.rightArrow) : p && (w.verbose("Selecting item from keyboard shortcut", c), w.event.item.click.call(c, e), k.useLabels && w.is.searchSelection() ? w.hideAndClear() : w.remove.searchTerm()), e.preventDefault()), t == n.leftArrow && (a = d[0] !== M[0], a && (w.verbose("Left key pressed, closing sub-menu"), w.animate.hide(!1, d), c.removeClass(S.selected), d.closest(E.item).addClass(S.selected), e.preventDefault())), t == n.rightArrow && m && (w.verbose("Right key pressed, opening sub-menu"), w.animate.show(!1, u), c.removeClass(S.selected), u.find(E.item).eq(0).addClass(S.selected), e.preventDefault()), t == n.upArrow) {
                                    if (o = g && f ? c.prevAll(E.item + ":not(" + E.unselectable + ")").eq(0) : U.eq(0), l.index(o) < 0)return w.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                ...
                                if (t == n.downArrow) {
                                    if (o = g && f ? o = c.nextAll(E.item + ":not(" + E.unselectable + ")").eq(0) : U.eq(0), 0 === o.length)return w.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                    ...
                    selectAction: function (t, n) {
                        ...
                        }, 0 === e(t.target).closest(j).length ? (w.verbose("Triggering event", n), n(), !0) : (w.verbose("Event occurred in dropdown, canceling callback"), !1)
                    }, eventOnElement: function (t, n) {
                        var i = e(t.target);
                        return n = e.isFunction(n) ? n : function () {
                        }, 0 === i.closest(M).length ? (w.verbose("Triggering event", n), n(), !0) : (w.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    ...
                    id: function () {
                        ...
                        return N.length > 0 ? N.val() : j.data(A.value)
                    }, values: function () {
                        var e = w.get.value();
                        return "" === e ? "" : !N.is("select") && w.is.multiple() ? "string" == typeof e ? e.split(k.delimiter) : "" : e
                        ...
                        return t = t !== i ? t : w.get.values() !== i ? w.get.values() : w.get.text(), o = a ? t.length > 0 : t !== i && "" !== t && null !== t, a = w.is.multiple() && e.isArray(t), n = "" === t || 0 === t ? !0 : n || !1, o && U.each(function () {
                            ...
                            } else if (c.toString() == t.toString() || s == t)return w.verbose("Found select item by value", c, t),
                                r = o, !0
                        }), r
                    }
                }, check: {
                    ...
                    filtered: function () {
                        ...
                        e && o && (w.verbose("Adjusting input width", a, k.glyphWidth), L.css("width", a)), o || n && r ? (w.verbose("Hiding placeholder text"), I.addClass(S.filtered)) : (!e || n && !r) && (w.verbose("Showing placeholder text"), I.removeClass(S.filtered))
                    }, loading: function () {
                        ...
                        w.has.search() ? (w.debug("Added tabindex to searchable dropdown"), L.val("").attr("tabindex", 0), M.attr("tabindex", -1)) : (w.debug("Added tabindex to dropdown"), j.attr("tabindex") || (j.attr("tabindex", 0), M.attr("tabindex", -1)))
                    }, initialLoad: function () {
                        w.verbose("Setting initial load"), h = !0
                    }, scrollPosition: function (e, t) {
                        var n, o, a, r, s, c, l, u, d, f = 5;
                        e = e || w.get.selectedItem(), n = e.closest(E.menu), o = e && e.length > 0, t = t !== i ? t : !1, e && n.length > 0 && o && (r = e.position().top, n.addClass(S.loading), c = n.scrollTop(), s = n.offset().top, r = e.offset().top, a = c - s + r, t || (l = n.height(), d = a + f > c + l, u = c > a - f), w.debug("Scrolling to active item", a), (t || u || d) && n.scrollTop(a), n.removeClass(S.loading))
                    }, text: function (e) {
                        "select" !== k.action && ("combo" == k.action ? (w.debug("Changing combo button text", e, H), k.preserveHTML ? H.html(e) : H.text(e)) : (w.debug("Changing text", e, I), I.removeClass(S.filtered).removeClass(S.placeholder), k.preserveHTML ? I.html(e) : I.text(e)))
                    }, selectedLetter: function (t) {
                        var n = U.filter("." + S.selected), i = !1;
                        U.each(function () {
                            var n = e(this), o = w.get.choiceText(n, !1), a = String(o).charAt(0).toLowerCase(), r = t.toLowerCase();
                            return a == r ? (i = n, !1) : void 0
                        }), i && (w.verbose("Scrolling to next value with letter", t), w.set.scrollPosition(i), n.removeClass(S.selected), i.addClass(S.selected))
                        ...
                        var i = N.length > 0, o = (!w.has.value(e), w.get.values()), a = "number" == typeof e ? e.toString() : e;
                        if (i) {
                            if (a == o && (w.verbose("Skipping value update already same value", e, o), !w.is.initialLoad()))return;
                            w.debug("Updating input value", e, o), N.val(e).trigger("change")
                        } else w.verbose("Storing value in metadata", e, N), e !== o && j.data(A.value, e);
                        ...
                        n = k.allowAdditions ? n || w.get.itemWithAdditions(t) : n || w.get.item(t), n && (w.debug("Setting selected menu item to", n), w.is.single() ? (w.remove.activeItem(), w.remove.selectedItem()) : k.useLabels && w.remove.selectedItem(), n.each(function () {
                            ...
                            i ? !s || c ? (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a), k.useLabels ? (w.add.value(a, o, t), w.add.label(a, o, l), t.addClass(S.active), w.filterActive(), w.select.nextAvailable(n)) : (w.add.value(a, o, t), w.set.text(w.add.variables(T.count)), t.addClass(S.active))) : r || (w.debug("Selected active value, removing label"), w.remove.selected(a)) : (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a), w.set.value(a, o, t), w.set.text(o), t.addClass(S.active).addClass(S.selected))
                        }))
                    }
                }, add: {
                    label: function (t, n, i) {
                        var o, a = w.is.searchSelection() ? L : I;
                        ...
                        var n = N.find('option[value="' + t + '"]'), i = n.length > 0;
                        i || (x && (x.disconnect(), w.verbose("Temporarily disconnecting mutation observer", t)), e("<option/>").prop("value", t).html(t).appendTo(N), w.verbose("Adding user addition as an <option>", t), x && x.observe(N[0], {
                            childList: !0,
                            subtree: !0
                        }))
                    ...
                    active: function () {
                        ...
                        w.verbose("Cleared search term"), L.val(""), w.set.filtered()
                    }, selected: function (t, n) {
                        ...
                        w.has.search() ? (w.debug("Searchable dropdown initialized"), L.attr("tabindex", "-1"), M.attr("tabindex", "-1")) : (w.debug("Simple selection dropdown initialized"), j.attr("tabindex", "-1"), M.attr("tabindex", "-1"))
                    }
                }, has: {
                    search: function () {
                        return L.length > 0
                    ...
                    active: function () {
                        ...
                        return w.has.search() && 0 === L.closest(E.menu).length
                    }, selection: function () {
                    ...
                    click: function () {
                        ...
                        return !j.hasClass(S.disabled) && U.length > 0
                    }, useAPI: function () {
                        return e.fn.api !== i
                    }
                }, animate: {
                    ...
                    w.has.search() ? (w.remove.searchTerm(), w.hide(function () {
    ...
    e.fn.embed = function (n) {
        var o, a = e(this), r = a.selector || "", s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
        return a.each(function () {
            var f, m = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.embed.settings, n) : e.extend({}, e.fn.embed.settings), g = m.selector, p = m.className, h = m.sources, v = m.error, b = m.metadata, y = m.namespace, x = m.templates, C = "." + y, w = "module-" + y, k = (e(t), e(this)), S = k.find(g.placeholder), T = k.find(g.icon), A = k.find(g.embed), P = this, R = k.data(w);
            f = {
                initialize: function () {
                    ...
                    events: function () {
                        f.has.placeholder() && (f.debug("Adding placeholder events"), console.log(k, g.placeholder), k.on("click" + C, g.placeholder, f.createAndShow).on("click" + C, g.icon, f.createAndShow))
                    }
                }, create: function () {
                    ...
                    f.refresh(), t = t || f.get.url(), console.log(t), A = e("<div/>").addClass(p.embed).html(f.generate.embed(t)).appendTo(k), m.onCreate.call(P, t), f.debug("Creating embed object", A)
                    ...
                    f.debug("Clearing embed and showing placeholder"), f.remove.active(), f.remove.embed(), f.showPlaceholder(), m.onReset.call(P)
                }, show: function () {
                    f.debug("Showing embed"), f.set.active(), m.onDisplay.call(P)
                }, hide: function () {
                    f.debug("Hiding embed"), f.showPlaceholder()
                }, showPlaceholder: function () {
                    f.debug("Showing placeholder image"), f.remove.active(), m.onPlaceholderDisplay.call(P)
                }, get: {
                    id: function () {
    ...
    e.fn.modal = function (o) {
        var a, r = e(this), s = e(t), c = e(n), l = e("body"), u = r.selector || "", d = (new Date).getTime(), f = [], m = arguments[0], g = "string" == typeof m, p = [].slice.call(arguments, 1), h = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                setTimeout(e, 0)
            };
        return r.each(function () {
            var r, v, b, y, x, C, w, k, S, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), A = T.selector, P = T.className, R = T.namespace, E = T.error, D = "." + R, O = "module-" + R, F = e(this), q = e(T.context), j = F.find(A.close), z = this, I = F.data(O);
            S = {
                initialize: function () {
                    ...
                    S.verbose("Storing instance of modal"), I = S, F.data(O, I)
                }, create: {
                    dimmer: function () {
                        var t = {
                            debug: T.debug,
                    ...
                    v = F.siblings(A.modal), r = v.add(F)
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    n = e.isFunction(S[n]) ? S[n] : S.toggle, i.length > 0 ? (S.debug("Attaching modal events to element", t, n), i.off(D).on("click" + D, n)) : S.error(E.notFound, t)
                }, bind: {
                    events: function () {
                        S.verbose("Attaching events"), F.on("click" + D, A.close, S.event.close).on("click" + D, A.approve, S.event.approve).on("click" + D, A.deny, S.event.deny), s.on("resize" + C, S.event.resize)
                    }
                }, get: {
                    id: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, S.is.animating() || !S.is.active() ? (S.showDimmer(), S.cacheSizes(), S.set.position(), S.set.screenHeight(), S.set.type(), S.set.clickaway(), !T.allowMultiple && S.others.active() ? S.hideOthers(S.showModal) : (T.onShow.call(z), T.transition && e.fn.transition !== i && F.transition("is supported") ? (S.debug("Showing modal with css animations"), F.transition({
                        debug: T.debug,
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, S.debug("Hiding modal"), T.onHide.call(z), (S.is.animating() || S.is.active()) && (T.transition && e.fn.transition !== i && F.transition("is supported") ? (S.remove.active(), F.transition({
                        debug: T.debug,
                    ...
                    return y.dimmer("is animating") || y.dimmer("is active") ? void y.dimmer("hide", function () {
                        T.transition && e.fn.transition !== i && F.transition("is supported") && (S.remove.clickaway(), S.remove.screenHeight())
                    }) : void S.debug("Dimmer is not visible cannot hide")
                }, hideAll: function (t) {
                    var n = r.filter("." + P.active + ", ." + P.animating);
                    t = e.isFunction(t) ? t : function () {
                    }, n.length > 0 && (S.debug("Hiding all visible modals"), S.hideDimmer(), n.modal("hide modal", t))
                }, hideOthers: function (t) {
                    var n = v.filter("." + P.active + ", ." + P.animating);
                    t = e.isFunction(t) ? t : function () {
                    ...
                    active: function () {
                        ...
                        return v.filter("." + P.animating).length > 0
                    }
                }, add: {
                    keyboardShortcuts: function () {
                        S.verbose("Adding keyboard shortcuts"), c.on("keyup" + D, S.event.keyboard)
                    }
                }, save: {
                    focus: function () {
                    ...
                    active: function () {
                        ...
                        S.verbose("Removing keyboard shortcuts"), c.off("keyup" + D)
                    }, scrolling: function () {
                        y.removeClass(P.scrolling), F.removeClass(P.scrolling)
                    }
                }, cacheSizes: function () {
                    var o = F.outerHeight();
                    ...
                    autofocus: function () {
                        if (T.autofocus) {
                            var e = F.filter(":input").filter(":visible"), t = e.filter("[autofocus]"), n = t.length > 0 ? t.first() : e.first();
                            n.length > 0 && n.focus()
                        }
                    }, clickaway: function () {
                        ...
                        y.addClass(P.scrolling), F.addClass(P.scrolling)
                    }, type: function () {
                        ...
                        S.verbose("Centering modal on page", S.cache), F.css(S.can.fit() ? {
                            top: "",
                            marginTop: -(S.cache.height / 2)
                        } : {marginTop: "", top: c.scrollTop()})
                    }, undetached: function () {
                        y.addClass(P.undetached)
                    }
                }, setting: function (t, n) {
    ...
    e.fn.popup = function (o) {
        var a, r = e(this), s = e(n), c = e(t), l = e("body"), u = r.selector || "", d = "ontouchstart"in n.documentElement, f = (new Date).getTime(), m = [], g = arguments[0], p = "string" == typeof g, h = [].slice.call(arguments, 1);
        return r.each(function () {
            var n, r, v, b, y, x = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings), C = x.selector, w = x.className, k = x.error, S = x.metadata, T = x.namespace, A = "." + x.namespace, P = "module-" + T, R = e(this), E = e(x.context), D = x.target ? e(x.target) : R, O = 0, F = !1, q = !1, j = this, z = R.data(P);
            y = {
                initialize: function () {
                    y.debug("Initializing", R), y.createID(), y.bind.events(), !y.exists() && x.preserve && y.create(), y.instantiate()
                }, instantiate: function () {
                    y.verbose("Storing instance", y), z = y, R.data(P, z)
                }, refresh: function () {
                    x.popup ? n = e(x.popup).eq(0) : x.inline && (n = D.next(C.popup).eq(0), x.popup = n), x.popup ? (n.addClass(w.loading), r = y.get.offsetParent(), n.removeClass(w.loading), x.movePopup && y.has.popup() && y.get.offsetParent(n)[0] !== r[0] && (y.debug("Moving popup to the same offset parent as activating element"), n.detach().appendTo(r))) : r = x.inline ? y.get.offsetParent(D) : y.has.popup() ? y.get.offsetParent(n) : l, r.is("html") && (y.debug("Setting page as offset parent"), r = l)
                }, reposition: function () {
                    y.refresh(), y.set.position()
                }, destroy: function () {
                    y.debug("Destroying previous module"), n && !x.preserve && y.removePopup(), clearTimeout(y.hideTimer), clearTimeout(y.showTimer), c.off(v), R.off(A).removeData(P)
                }, event: {
                    start: function (t) {
                    ...
                    show: function (t) {
                        ...
                        }, y.debug("Hiding pop-up"), x.onShow.call(n, j) === !1 ? void y.debug("onShow callback returned false, cancelling popup animation") : void(x.transition && e.fn.transition !== i && R.transition("is supported") ? n.transition({
                    ...
                    html: function () {
                        ...
                        return R.removeData(S.content), R.data(S.content) || R.attr("title") || x.content
                    }, variation: function () {
                        return R.removeData(S.variation), R.data(S.variation) || x.variation
                    }, calculations: function () {
                        var e, i = D[0], o = x.inline || x.popup ? D.position() : D.offset(), a = {};
                        return a = {
                            target: {
                                element: D[0],
                                width: D.outerWidth(),
                        ...
                        return F || (y.verbose("All available positions available"), F = y.get.positions()), y.debug("Recording last position tried", e), F[e] = !0, "opposite" === x.prefer && (u = [o[n], i], u = u.join(" "), c = F[u] === !0, y.debug("Trying opposite strategy", u)), "adjacent" === x.prefer && s && (u = [n, a[i]], u = u.join(" "), l = F[u] === !0, y.debug("Trying adjacent strategy", u)), (l || c) && (y.debug("Using backup position", u), u = r[e]), u
                    }
                }, set: {
                    position: function (e, t) {
                        if (0 === D.length || 0 === n.length)return void y.error(k.notFound);
                        var o, a, r, s, c, l, u;
                        if (t = t || y.get.calculations(), e = e || R.data(S.position) || x.position, o = R.data(S.offset) || x.offset, a = x.distanceAway, r = t.target, s = t.popup, c = t.parent, 0 === r.top && 0 === r.left)return y.debug("Popup target is hidden, no action taken"), !1;
                        ...
                        }), y.debug("RTL: Popup position updated", e)), O == x.maxSearchDepth && x.lastResort && (y.debug('Using "last resort" position to display', x.lastResort), e = x.lastResort), e) {
                            case"top left":
                        ...
                        if (l === i && y.error(k.invalidPosition, e), y.debug("Calculated popup positioning values", l), n.css(l).removeClass(w.position).addClass(e).addClass(w.loading), u = y.get.offstagePosition(e, t)) {
                            if (y.debug("Popup cant fit into viewport", e, u), O < x.maxSearchDepth)return O++, e = y.get.nextPosition(e), y.debug("Trying new position", e), n ? y.set.position(e, t) : !1;
                    ...
                    loading: function () {
                        ...
                        y.verbose("Resetting all searched positions"), O = 0, F = !1
                    }
                }, bind: {
                    events: function () {
                        y.debug("Binding popup events to module"), "click" == x.on && R.on("click" + A, y.toggle), "hover" == x.on && d ? R.on("touchstart" + A, y.event.touchstart) : y.get.startEvent() && R.on(y.get.startEvent() + A, y.event.start).on(y.get.endEvent() + A, y.event.end), x.target && y.debug("Target set to element", D), c.on("resize" + v, y.event.resize)
                    }, popup: function () {
            ...
            m = {
                initialize: function () {
                    ...
                    input: function () {
                        ...
                        m.set.focus(), m.has.minimumCharacters() && (m.query(), m.showResults())
                    }, blur: function (e) {
                        ...
                        mousedown: function () {
                            ...
                            var i = e(this), o = i.find(b.title).eq(0), a = i.find("a[href]").eq(0), r = a.attr("href") || !1, s = a.attr("target") || !1, c = (o.html(), o.length > 0 ? o.text() : !1), l = m.get.results(), u = i.data(h.result) || m.get.result(c, l);
                    ...
                    m.has.minimumCharacters() ? n ? (m.debug("Reading result from cache", t), m.save.results(n.results), m.addResults(n.html), m.inject.id(n.results)) : (m.debug("Querying for", t), e.isPlainObject(g.source) || e.isArray(g.source) ? m.search.local(t) : m.can.useAPI() ? m.search.remote(t) : m.error(y.source), g.onSearchQuery.call(P, t)) : m.hideResults()
                }, search: {
                    local: function (e) {
                        ...
                        var n = {
                            onSuccess: function (e) {
                                ...
                                m.displayMessage(y.serverError)
                            }, urlData: {query: t}
                        };
                        ...
                        var a = [], r = [], s = t.toString().replace(v.escape, "\\$&"), c = new RegExp(v.beginsWith + s, "i"), l = function (t, n) {
                            var i = -1 == e.inArray(n, a), o = -1 == e.inArray(n, r);
                            i && o && t.push(n)
                        };
                        return n = n || g.source, o = o !== i ? o : g.searchFields, e.isArray(o) || (o = [o]), n === i || n === !1 ? (m.error(y.source), []) : (e.each(o, function (i, o) {
                    ...
                    response: function (e, t) {
                        ...
                        m.verbose("Parsing server response", e), e !== i && t !== i && e.results !== i && (m.addResults(n), m.inject.id(e.results), m.write.cache(t, {
                            html: n,
                            results: e.results
    ...
    e.fn.sidebar = function (o) {
        var a, r = e(this), s = e(t), c = e(n), l = e("html"), u = e("head"), d = r.selector || "", f = (new Date).getTime(), m = [], g = arguments[0], p = "string" == typeof g, h = [].slice.call(arguments, 1), v = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                setTimeout(e, 0)
            };
        return r.each(function () {
            var r, b, y, x, C, w, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), S = k.selector, T = k.className, A = k.namespace, P = k.regExp, R = k.error, E = "." + A, D = "module-" + A, O = e(this), F = e(k.context), q = O.children(S.sidebar), j = F.children(S.fixed), z = F.children(S.pusher), I = this, L = O.data(D);
            w = {
                initialize: function () {
                    ...
                    w.verbose("Storing instance of module", w), L = w, O.data(D, w)
                }, create: {
                    id: function () {
                        y = (Math.random().toString(16) + "000000000").substr(2, 8), b = "." + y, w.verbose("Creating unique id for element", y)
                    }
                }, destroy: function () {
                    w.verbose("Destroying previous module for", O), w.remove.direction(), O.off(E).removeData(D), w.is.ios() && w.remove.ios(), F.off(b), s.off(b), c.off(b)
                }, event: {
                    clickaway: function (e) {
                        var t = z.find(e.target).length > 0 || z.is(e.target), n = F.is(e.target);
                    ...
                    clickaway: function () {
                        w.verbose("Adding clickaway events to context", F), k.closable && F.on("click" + b, w.event.clickaway).on("touchend" + b, w.event.clickaway)
                    }, scrollLock: function () {
                        k.scrollLock && (w.debug("Disabling page scroll"), s.on("DOMMouseScroll" + b, w.event.scroll)), w.verbose("Adding events to contain sidebar scroll"), c.on("touchmove" + b, w.event.touch), O.on("scroll" + E, w.event.containScroll)
                    }
                }, unbind: {
                    clickaway: function () {
                        w.verbose("Removing clickaway events from context", F), F.off(b)
                    }, scrollLock: function () {
                        w.verbose("Removing scroll lock from page"), c.off(b), s.off(b), O.off("scroll" + E)
                    }
                }, add: {
                    inlineCSS: function () {
                    ...
                    w.verbose("Refreshing selector cache"), F = e(k.context), q = F.children(S.sidebar), z = F.children(S.pusher), j = F.children(S.fixed), w.clear.cache()
                }, refreshSidebars: function () {
                    w.verbose("Refreshing other sidebars"), q = F.children(S.sidebar)
                }, repaint: function () {
                    ...
                    cache: function () {
                        ...
                        0 === F.children(S.pusher).length && (w.debug("Adding wrapper element for sidebar"), w.error(R.pusher), z = e('<div class="pusher" />'), F.children().not(S.omitted).not(q).wrapAll(z), w.refresh()), (0 === O.nextAll(S.pusher).length || O.nextAll(S.pusher)[0] !== z[0]) && (w.debug("Moved sidebar to correct parent element"), w.error(R.movedSidebar, I), O.detach().prependTo(F), w.refresh()), w.clear.cache(), w.set.pushable(), w.set.direction()
                    }
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    ...
                    inlineCSS: function () {
                        ...
                        F.removeClass(T.pushed)
                    }, pushable: function () {
                        F.removeClass(T.pushable)
                    }, active: function () {
                    ...
                    ie: function () {
                        ...
                        var e = navigator.userAgent, t = e.match(P.ios), n = e.match(P.mobileChrome);
                    ...
                    var r, s, c, l = L;
                    return n = n || h, o = I || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
        ...
        return a.each(function () {
            ...
            g = {
                initialize: function () {
                    ...
                    lastScroll: function (e) {
                    ...
                    }, positions: function () {
                        {
                            var e = {height: w.height()}, t = {
                                ...
                                bottomPadding: parseInt(f.css("padding-bottom"), 10)
                            };
                    ...
                    g.debug("Removing absolute position on element"), g.remove.offset(), C.removeClass(h.bound).removeClass(h.top).removeClass(h.bottom)
                }, unfix: function () {
                    g.debug("Removing fixed position on element"), g.remove.offset(), C.removeClass(h.fixed).removeClass(h.top).removeClass(h.bottom), p.onUnstick.call(A)
                }, reset: function () {
    ...
    e.fn.tab = function (o) {
        ...
        return r.each(function () {
            var g, p, h, v, b, y, x = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.tab.settings, o) : e.extend({}, e.fn.tab.settings), C = x.className, w = x.metadata, k = x.selector, S = x.error, T = "." + x.namespace, A = "module-" + x.namespace, P = e(this), R = {}, E = !0, D = 0, O = this, F = P.data(A);
            b = {
                initialize: function () {
                    b.debug("Initializing tab menu item", P), b.fix.callbacks(), b.determineTabs(), b.debug("Determining tabs", x.context, p), x.auto && b.set.auto(), b.bind.events(), x.history && !m && (b.initializeHistory(), m = !0), b.instantiate()
                }, instantiate: function () {
                    b.verbose("Storing instance of module", b), F = b, P.data(A, b)
                }, destroy: function () {
                    b.debug("Destroying tabs", P), P.removeData(A).off(T)
                }, bind: {
                    events: function () {
                        e.isWindow(O) || (b.debug("Attaching tab activation events to element", P), P.on("click" + T, b.event.click))
                    }
                }, determineTabs: function () {
                    var t;
                    "parent" === x.context ? (P.closest(k.ui).length > 0 ? (t = P.closest(k.ui), b.verbose("Using closest UI element as parent", t)) : t = P, g = t.parent(), b.verbose("Determined parent element for creating context", g)) : x.context ? (g = e(x.context), b.verbose("Using selector for tab context", x.context, g)) : g = e("body"), x.childrenOnly ? (p = g.children(k.tabs), b.debug("Searching tab context children for tabs", g, p)) : (p = g.find(k.tabs), b.debug("Searching tab context for tabs", g, p))
                }, fix: {
                    callbacks: function () {
                    ...
                    n = b.utilities.arrayToPath(r), e.each(r, function (t, i) {
                        var s, c, l, u, d = r.slice(0, t + 1), f = b.utilities.arrayToPath(d), m = b.is.tab(f), p = t + 1 == r.length, w = b.get.tabElement(f);
                        if (b.verbose("Looking for tab", i), m) {
                            if (b.verbose("Tab was found", i), h = f, v = b.utilities.filterArray(r, d), p ? u = !0 : (c = r.slice(0, t + 2), l = b.utilities.arrayToPath(c), u = !b.is.tab(l), u && b.verbose("Tab parameters found", c)), u && a)return o ? (b.debug("Ignoring remote content on first tab load", f), E = !1, b.cache.add(n, w.html()), b.activate.all(f), x.onFirstLoad.call(w[0], f, v, y), x.onLoad.call(w[0], f, v, y)) : (b.activate.navigation(f), b.fetch.content(f, n)), !1;
                            b.debug("Opened local tab", f), b.activate.all(f), b.cache.read(f) || (b.cache.add(f, !0), b.debug("First time tab loaded calling tab init"), x.onFirstLoad.call(w[0], f, v, y)), x.onLoad.call(w[0], f, v, y)
                        } else {
                            if (-1 != n.search("/") || "" === n)return b.error(S.missingTab, P, g, f), !1;
                            if (s = e("#" + n + ', a[name="' + n + '"]'), f = s.closest("[data-tab]").data("tab"), w = b.get.tabElement(f), s && s.length > 0 && f)return b.debug("Anchor link used, opening parent tab", w, s), w.hasClass(C.active) || setTimeout(function () {
                                b.scrollTo(s)
                            }, 0), b.activate.all(f), b.cache.read(f) || (b.cache.add(f, !0), b.debug("First time tab loaded calling tab init"), x.onFirstLoad.call(w[0], f, v, y)), x.onLoad.call(w[0], f, v, y), !1
                        }
                    })
                }, scrollTo: function (t) {
                    ...
                    initialPath: function () {
                        ...
                        var t, n, i, o;
                        return e = e || h, i = b.utilities.pathToArray(e), o = b.utilities.last(i), t = p.filter("[data-" + w.tab + '="' + o + '"]'), n = p.filter("[data-" + w.tab + '="' + e + '"]'), t.length > 0 ? t : n
                    }, tab: function () {
                        return h
                    }
                }, utilities: {
                    ...
                    var r, s, c, l = F;
                    return n = n || f, o = O || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
            ...
            C = {
                initialize: function () {
                    ...
                    animation: function (e) {
                        e = e || C.get.animationClass(), C.debug("Starting tween", e), w.addClass(e).one(b + ".complete" + x, C.complete), m.useFailSafe && C.add.failSafe(), C.set.duration(m.duration), m.onStart.call(this)
                    }
                }, save: {
                    animation: function (e) {
                    ...
                    C.verbose("Hiding element"), C.is.animating() && C.reset(), k.blur(), C.remove.display(), C.remove.visible(), C.set.hidden(), m.onHide.call(this), m.onComplete.call(this), C.force.hidden()
                }, show: function (e) {
                    C.verbose("Showing element", e), C.remove.hidden(), C.set.visible(), m.onShow.call(this), m.onComplete.call(this), C.force.visible()
                }, toggle: function () {
    ...
    e.api = e.fn.api = function (n) {
        ...
        return a.each(function () {
            var a, f, m, g, p, h, v = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.api.settings, n) : e.extend({}, e.fn.api.settings), b = v.namespace, y = v.metadata, x = v.selector, C = v.error, w = v.className, k = "." + b, S = "module-" + b, T = e(this), A = T.closest(x.form), P = v.stateContext ? e(v.stateContext) : T, R = this, E = P[0], D = T.data(S);
            h = {
                initialize: function () {
                    u || h.bind.events(), h.instantiate()
                }, instantiate: function () {
                    h.verbose("Storing instance of module", h), D = h, T.data(S, D)
                }, destroy: function () {
                    h.verbose("Destroying previous module for", R), T.removeData(S).off(k)
                }, bind: {
                    events: function () {
                        var e = h.get.event();
                        e ? (h.verbose("Attaching API events to element", e), T.on(e + k, h.event.trigger)) : "now" == v.on && (h.debug("Querying API now", e), h.query())
                    }
                }, read: {
                    cachedResponse: function (e) {
                        var n;
                        if (t.Storage === i)return void h.error(C.noStorage);
                        if (n = sessionStorage.getItem(e), h.debug("Using cached response", e, n), n !== i) {
                            try {
                                n = JSON.parse(n)
                            } catch (o) {
                            }
                    ...
                    disabled: function () {
                        ...
                        return "json" === v.dataType && e.isFunction(v.successTest) ? (h.debug("Checking JSON returned success", v.successTest, t), v.successTest(t) ? (h.debug("Response passed success test", t), !0) : (h.debug("Response failed success test", t), !1)) : (h.verbose("Response is not JSON, skipping validation", v.successTest, t), !0)
                    }
                }, was: {
                    cancelled: function () {
                    ...
                    urlData: function (t, n) {
                        ...
                        return t && (o = t.match(v.regExp.required), a = t.match(v.regExp.optional), n = n || v.urlData, o && (h.debug("Looking for required URL variables", o), e.each(o, function (o, a) {
                            var r = -1 !== a.indexOf("$") ? a.substr(2, a.length - 3) : a.substr(1, a.length - 2), s = e.isPlainObject(n) && n[r] !== i ? n[r] : T.data(r) !== i ? T.data(r) : P.data(r) !== i ? P.data(r) : n[r];
                            return s === i ? (h.error(C.requiredParameter, r, t), t = !1, !1) : (h.verbose("Found required variable", r, s), void(t = t.replace(a, s)))
                        })), a && (h.debug("Looking for optional URL variables", o), e.each(a, function (o, a) {
                            var r = -1 !== a.indexOf("$") ? a.substr(3, a.length - 4) : a.substr(2, a.length - 3), s = e.isPlainObject(n) && n[r] !== i ? n[r] : T.data(r) !== i ? T.data(r) : P.data(r) !== i ? P.data(r) : n[r];
                    ...
                    trigger: function (e) {
                        ...
                        always: function () {
                            ...
                            var o = this, a = (new Date).getTime() - p, r = v.loadingDuration - a, s = e.isFunction(v.onResponse) ? v.onResponse.call(o, e.extend(!0, {}, t)) : !1;
                            r = r > 0 ? r : 0, s && (h.debug("Modified API response in onResponse callback", v.onResponse, s, t), t = s), r > 0 && h.debug("Response completed early delaying state change by", r), setTimeout(function () {
                                h.is.validResponse(t) ? h.request.resolveWith(o, [t]) : h.request.rejectWith(o, [i, "invalid"])
                            }, r)
                        }, fail: function (e, t, n) {
                        ...
                        complete: function (e) {
                            h.remove.loading(), v.onComplete.call(E, e, T)
                        }, done: function (e) {
                            h.debug("Successful API Response", e), "local" === v.cache && m && (h.write.cachedResponse(m, e), h.debug("Saving server response locally", h.cache)), v.onSuccess.call(E, e, T)
                        }, fail: function (t, n, o) {
                            var r = e.isPlainObject(t) ? t.responseText : !1, s = e.isPlainObject(r) && r.error !== i ? r.error : v.error[n] !== i ? v.error[n] : o;
                            "aborted" == n ? (h.debug("XHR Aborted (Most likely caused by page navigation or CORS Policy)", n, o), v.onAbort.call(E, n, T)) : "invalid" == n ? h.debug("JSON did not pass success test. A server-side error has most likely occurred", r) : "error" == n && t !== i && (h.debug("XHR produced a server error", n, o), 200 != t.status && o !== i && "" !== o && h.error(C.statusMessage + o, a.url), v.onError.call(E, s, T)), v.errorDuration && "aborted" !== n && (h.debug("Adding error state"), h.set.error(), setTimeout(h.remove.error, v.errorDuration)), h.debug("API Request failed", s, t), v.onFailure.call(E, r, T)
                        }
                    }
                }, create: {
                    request: function () {
                    ...
                    error: function () {
                        h.verbose("Adding error state to element", P), P.addClass(w.error)
                    }, loading: function () {
                        h.verbose("Adding loading state to element", P), P.addClass(w.loading), p = (new Date).getTime()
                    }
                }, remove: {
                    error: function () {
                        h.verbose("Removing error state from element", P), P.removeClass(w.error)
                    }, loading: function () {
                        h.verbose("Removing loading state from element", P), P.removeClass(w.loading)
                    }
                }, get: {
                    request: function () {
                        return h.request || !1
                        ...
                        var t = {};
                        return e.isWindow(R) || (h.is.input() ? t.value = T.val() : h.is.form() && (t.text = T.text())), t
                    }, event: function () {
                        return e.isWindow(R) || "now" == v.on ? (h.debug("API called without element, no events attached"), !1) : "auto" == v.on ? T.is("input") ? R.oninput !== i ? "input" : R.onpropertychange !== i ? "propertychange" : "keyup" : T.is("form") ? "submit" : "click" : v.on
                        ...
                        if (e) {
                            ...
                            m = v.api[e]
                        } else h.is.form() && (m = T.attr("action") || !1, h.debug("No url or action specified, defaulting to form action", m));
                        return m
                    }
                }, abort: function () {
                    var e = h.get.xhr();
            ...
            }, u ? (D === i && h.initialize(), h.invoke(l)) : (D !== i && D.invoke("destroy"), h.initialize())
        }), o !== i ? o : this
    }, e.api.settings = {
        name: "API",
        namespace: "api",
        ...
        return r.each(function () {
            ...
            g = {
                initialize: function () {
                    ...
                    }), m.observe(P, {childList: !0, subtree: !0}), g.debug("Setting up mutation observer", m))
                }, bind: {
                    events: function () {
                    ...
                    cache: function () {
                        ...
                        e && (g.verbose("Lazy loading image", e), p.once = !0, p.observeChanges = !1, p.onOnScreen = function () {
                            g.debug("Image on screen", P), g.precache(e, function () {
                                g.set.image(e)
                            })
                        })
                    }, fixed: function () {
                    ...
                    e = e || !1, e && (p.continuous ? (g.debug("Callback being called continuously", t, n), e.call(P, n, i)) : g.get.occurred(t) || (g.debug("Conditions met", t, n), e.call(P, n, i))), g.save.occurred(t)
                }, remove: {
                    fixed: function () {
