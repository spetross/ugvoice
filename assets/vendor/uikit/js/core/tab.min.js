...
!function (t) {
    ...
    t.component("tab", {
        defaults: {
            ...
            if (i.length) {
                var e, n, s = i.eq(0).offset().top + Math.ceil(i.eq(0).height() / 2), a = !1;
                if (this.responsivetab.lst.empty(), i.each(function () {
                        t.$(this).offset().top > s && (a = !0)
                    }), a)for (var o = 0; o < i.length; o++)e = t.$(i.eq(o)), n = e.find("a"), "none" == e.css("float") || e.attr("uk-dropdown") || (e.addClass("uk-hidden"), e.hasClass("uk-disabled") || this.responsivetab.lst.append('<li><a href="' + n.attr("href") + '" data-index="' + o + '">' + n.html() + "</a></li>"));
