...
!function (t) {
    ...
    t.component("stackMargin", {
        ...
        return t.$win.on("resize", t.Utils.debounce(n, 15)), function (s) {
            t.$("iframe.uk-responsive-width", s).each(function () {
                var n = t.$(this);
        ...
        var s = !1, e = i.filter(":visible:first"), a = e.length ? e.position().top + e.outerHeight() - 1 : !1;
        a !== !1 && i.each(function () {
            var i = t.$(this);
            i.is(":visible") && (s ? i.addClass(n.cls) : i.position().top >= a && (s = i.addClass(n.cls)))
        })
    }
}(UIkit);